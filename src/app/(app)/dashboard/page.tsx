...
export default function Dashboard(){
  ...
  return <AppShell>
    ...
    <div className="grid md:grid-cols-3 gap-6 mt-6">
      <Card className="md:col-span-2"><h3 className="font-semibold">Leads collected over time</h3><div className="h-40 flex items-end gap-1 mt-4">{[20,35,45,30,60,55,80].map((h,i)=><div key={i} style={{height:h*2}} className="flex-1 bg-zinc-900 rounded-t bg-zinc-900"/>)} </div><p className="text-xs text-zinc-500 mt-2">Last 7 days</p></Card>
